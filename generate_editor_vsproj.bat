...
cmake -DADS_VERSION=4.4.1 -DQT_VERSION_MAJOR=6 -DBUILD_EXAMPLES=OFF -DASSIMP_BUILD_TESTS=OFF -G "Visual Studio 17 2022" -A x64 -B "ThoriumEditor/Intermediate/build" "ThoriumEditor/Intermediate"
pause

...
void CAssetBrowserWidget::RenderUI(float width, float height)
{
	...
	if (ImGui::BeginChild("assetBrowserWnd", ImVec2(width, height)))
	{
		...
		if (ImGui::BeginChild("assetBrowserView", ImVec2(sizeR - 8, 0), true, ImGuiWindowFlags_AlwaysUseWindowPadding))
		{
